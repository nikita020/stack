...
const AcceptButtonLabel = styled.Text`
  color: ${constants.headerColorDarkBlue};
  fontSize: 18;
  fontWeight: 700
`
...
export default class RemoveCardPopup extends Component {
  render () {
    return (
      <ViewContainer>
        <ContentLayout>
          <ViewWithHeader>
            <BankName>Card Name</BankName>
            <ConfirmText>
              <ConfirmTextTitle>Are you sure, you want to remove this card:</ConfirmTextTitle>
