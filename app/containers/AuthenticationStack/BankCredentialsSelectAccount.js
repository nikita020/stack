...
import { statusBarHeight, headerColorViolet, windowWidth, colorViolet, headerColorDarkBlue } from '../../../constants'
        ...
        <View style={ {flex: 1, alignItems: 'center', alignContent: 'stretch', width: windowWidth} }>
          <View style={ [
            ...
            <View style={ styles.customHeaderContent }>
              <Text style={ styles.textWhite }>{ 'Select your Account' }</Text>
            </View>
          </View>
          <ViewContainer style={ {...styles.backgroundWhite, justifyContent: 'flex-start'} }>
            ...
            <View style={ [styles.containerCenter, styles.vw100] }>
              ...
              <Button
                btnBlue={ true }
                style={ styles.vw90 }
                onPress={ () => this.props.navigation.navigate('PortfolioChoose') }
